...
<body>
    ...
    <div class="admin">
        ...
        <div class="admin_right">
            ...
            <b><h2 style="text-align: center; padding-top: 30px">Danh Sách Đơn Hàng Đang Vận chuyển</h2></b>
            ...
            <table class="table table-hover">
                ...
                @foreach($DonHangs as $DonHangs)
                    <tr>
                        ...
                        <td style="max-width: 120px; ;overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{$DonHangs->PhuongThucThanhToan}}</td>
