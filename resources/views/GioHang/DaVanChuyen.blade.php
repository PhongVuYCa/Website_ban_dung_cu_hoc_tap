...
<head>
    ...
    <title>Đơn hàng đã vận chuyển</title>
</head>
<body>
@include('header')
...
<div style="padding: 20px;  width: 100%; border: 2px solid #c3b9f4d8">
    ...
    <a>Trang chủ / </a><a style="color:#2d08e9d8">Đơn hàng đã vận chuyển</a>
</div>
<div style="width:100%;min-height:200px;" class="home">
    ...
    <div class="home_right" >
        ...
        <div style="margin:40px 0 300px 0;text-align: center;">Đơn hàng đã vận chuyển của bạn đang trống.</div>
        @else
        <h3 style="text-align: center; margin-top: 40px"><b>Đơn Hàng Đã vận Chuyển</b></h3>
        <div class="Giohang" >
                ...
                <tbody>
                    ...
                    @foreach ($DonHangItems as $item)
                        <tr>
                            ...
                            @if($item->DanhGia==null)
                            <td>
                                <a style="text-decoration:none; color:black;  text-align: center" href="{{ url('/DanhGiaSanPham/' . $item->id) }}" >
                                    <h6>Viết đánh giá</h6>
                                </a>
                            </td>
                            @else
                            <td><h6 style="text-align: center; width:200px;">{{ $item->DanhGia}}</h6></td>
                            @endif
                        </tr>
                        @php
                            $counter++;
